...
namespace VanishFlare.Windows.Forms
{
    ...
    public abstract class VfTextBoxBase<T> : MetTextBox, IFieldComtrolMaps<T> where T : FieldControlMapBase
    {
        /// <summary>
        /// 新しい VfTextBoxBase のインスタンスを生成します。
        /// </summary>
        public VfTextBoxBase() : base()
        {
